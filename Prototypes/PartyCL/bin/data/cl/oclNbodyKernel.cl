...
static REAL3 bodyBodyInteraction(REAL3 ai, REAL4 bi, REAL4 bj, REAL softeningSquared) 
{
    REAL3 r;
...
static REAL3 gravitation(REAL4 myPos, REAL3 accel, REAL softeningSquared, __local REAL4* sharedPos)
{
