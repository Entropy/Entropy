...
// JobChain in translated ASCII characters for text input.
...
// JobChain data_size==0 for zero-terminated string
...
// JobChain text data straight to log (without being displayed)
