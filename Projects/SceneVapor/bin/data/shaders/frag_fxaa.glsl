...
vec4 fxaa_311(sampler2D _sampler, vec2 _coord, vec2 _invScrSize, float _quality, float _treshold, float _tresholdMin)
{
    return FxaaPixelShader(_coord*_invScrSize //pos
                         , vec4(0.0)    //fxaaConsolePosPos              - placeholder
                         , _sampler           //tex
                         ...
                         , vec4(0.0)    //fxaaConsoleRcpFrameOpt         - placeholder
                         , vec4(0.0)    //fxaaConsoleRcpFrameOpt2        - placeholder
                         , vec4(0.0)    //fxaaConsole360RcpFrameOpt2     - placeholder
                         ...
                         , vec4(0.0)    //fxaaConsole360ConstDir         - placeholder
                         );
}
...
void main(){
    float x = 1/1280.;
    float y = 1/720.;
    fragColor = vec4(fxaa_311(tex0, f_texcoord * vec2(1280., 720.), vec2(x,y)).rgb, 1.0);
}
